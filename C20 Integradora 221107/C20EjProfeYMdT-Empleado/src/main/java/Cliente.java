...
public class Cliente {
    ...
    public static void main(String[] args) {
        ...
        Empresa empresa = new Empresa("20-123456-0","HelloWorld",listadoEmpleados);

        System.out.println(empresa);

        ManejadorEntradaSalida.guardarListaEmpleadosFormatoEspecial(listadoEmpleados);

        ManejadorEntradaSalida.guardarEmpresa(empresa);

        ManejadorEntradaSalida.recuperarEmpresa("empresa.txt");
